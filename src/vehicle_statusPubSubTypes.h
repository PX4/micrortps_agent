...
/*!
 * @file vehicle_statusPubSubTypes.h
...
#ifndef _VEHICLE_STATUS_PUBSUBTYPES_H_
#define _VEHICLE_STATUS_PUBSUBTYPES_H_
...
#error Generated vehicle_status is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 */
class vehicle_statusPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef vehicle_status type;

    eProsima_user_DllExport vehicle_statusPubSubType();

    eProsima_user_DllExport virtual ~vehicle_statusPubSubType();
...
#endif // _VEHICLE_STATUS_PUBSUBTYPES_H_