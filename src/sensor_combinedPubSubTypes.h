...
/*!
 * @file sensor_combinedPubSubTypes.h
...
#ifndef _SENSOR_COMBINED_PUBSUBTYPES_H_
#define _SENSOR_COMBINED_PUBSUBTYPES_H_
...
#error Generated sensor_combined is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
/*!
 * @brief This class represents the TopicDataType of the type sensor_combined defined by the user in the IDL file.
 * @ingroup SENSOR_COMBINED
 */
class sensor_combinedPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef sensor_combined type;

    eProsima_user_DllExport sensor_combinedPubSubType();

    eProsima_user_DllExport virtual ~sensor_combinedPubSubType();
...
#endif // _SENSOR_COMBINED_PUBSUBTYPES_H_