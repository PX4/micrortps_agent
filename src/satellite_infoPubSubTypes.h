...
/*!
 * @file satellite_infoPubSubTypes.h
...
#ifndef _SATELLITE_INFO_PUBSUBTYPES_H_
#define _SATELLITE_INFO_PUBSUBTYPES_H_
...
#error Generated satellite_info is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif


typedef std::array<uint8_t, 20> satellite_info__octet_array_20;
/*!
 * @brief This class represents the TopicDataType of the type satellite_info defined by the user in the IDL file.
 * @ingroup SATELLITE_INFO
 */
class satellite_infoPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef satellite_info type;

    eProsima_user_DllExport satellite_infoPubSubType();

    eProsima_user_DllExport virtual ~satellite_infoPubSubType();
...
#endif // _SATELLITE_INFO_PUBSUBTYPES_H_