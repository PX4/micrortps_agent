...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@14ec4505
    m_timestamp_ = 0;
    // m_nav_state_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@53ca01a2
    m_nav_state_ = 0;
    // m_nav_state_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@358c99f5
    m_nav_state_timestamp_ = 0;
    // m_arming_state_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3ee0fea4
    m_arming_state_ = 0;
    // m_hil_state_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@48524010
    m_hil_state_ = 0;
    // m_failsafe_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4b168fa9
    m_failsafe_ = false;
    // m_failsafe_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a84f40f
    m_failsafe_timestamp_ = 0;
    // m_system_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23282c25
    m_system_type_ = 0;
    // m_system_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7920ba90
    m_system_id_ = 0;
    // m_component_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6b419da
    m_component_id_ = 0;
    // m_vehicle_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3b2da18f
    m_vehicle_type_ = 0;
    // m_is_vtol_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5906ebcb
    m_is_vtol_ = false;
    // m_is_vtol_tailsitter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@258e2e41
    m_is_vtol_tailsitter_ = false;
    // m_vtol_fw_permanent_stab_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3d299e3
    m_vtol_fw_permanent_stab_ = false;
    // m_in_transition_mode_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55a561cf
    m_in_transition_mode_ = false;
    // m_in_transition_to_fw_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3b938003
    m_in_transition_to_fw_ = false;
    // m_rc_signal_lost_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6f3b5d16
    m_rc_signal_lost_ = false;
    // m_rc_input_mode_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@78b1cc93
    m_rc_input_mode_ = 0;
    ...
    // m_engine_failure_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6295d394
