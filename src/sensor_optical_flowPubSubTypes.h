...
/*!
 * @file sensor_optical_flowPubSubTypes.h
...
#ifndef _SENSOR_OPTICAL_FLOW_PUBSUBTYPES_H_
#define _SENSOR_OPTICAL_FLOW_PUBSUBTYPES_H_
...
#error Generated sensor_optical_flow is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 */
class sensor_optical_flowPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef sensor_optical_flow type;

    eProsima_user_DllExport sensor_optical_flowPubSubType();

    eProsima_user_DllExport virtual ~sensor_optical_flowPubSubType();
...
#endif // _SENSOR_OPTICAL_FLOW_PUBSUBTYPES_H_