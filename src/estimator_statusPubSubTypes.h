...
/*!
 * @file estimator_statusPubSubTypes.h
...
#ifndef _ESTIMATOR_STATUS_PUBSUBTYPES_H_
#define _ESTIMATOR_STATUS_PUBSUBTYPES_H_
...
#error Generated estimator_status is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 */
class estimator_statusPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef estimator_status type;

    eProsima_user_DllExport estimator_statusPubSubType();

    eProsima_user_DllExport virtual ~estimator_statusPubSubType();
...
#endif // _ESTIMATOR_STATUS_PUBSUBTYPES_H_