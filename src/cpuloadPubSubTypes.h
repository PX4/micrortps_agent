...
#ifndef _CPULOAD_PUBSUBTYPES_H_
#define _CPULOAD_PUBSUBTYPES_H_
...
#error Generated cpuload is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type cpuload defined by the user in the IDL file.
 * @ingroup CPULOAD
 */
class cpuloadPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef cpuload type;

    eProsima_user_DllExport cpuloadPubSubType();

    eProsima_user_DllExport virtual ~cpuloadPubSubType();
