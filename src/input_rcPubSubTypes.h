...
#ifndef _INPUT_RC_PUBSUBTYPES_H_
#define _INPUT_RC_PUBSUBTYPES_H_
...
#error Generated input_rc is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 * @ingroup INPUT_RC
 */
class input_rcPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef input_rc type;

    eProsima_user_DllExport input_rcPubSubType();

    eProsima_user_DllExport virtual ~input_rcPubSubType();
...
#endif // _INPUT_RC_PUBSUBTYPES_H_