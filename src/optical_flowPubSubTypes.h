...
/*!
 * @file optical_flowPubSubTypes.h
...
#ifndef _OPTICAL_FLOW_PUBSUBTYPES_H_
#define _OPTICAL_FLOW_PUBSUBTYPES_H_
 ...
 */
class optical_flowPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef optical_flow type;

    eProsima_user_DllExport optical_flowPubSubType();

    eProsima_user_DllExport virtual ~optical_flowPubSubType();
...
#endif // _OPTICAL_FLOW_PUBSUBTYPES_H_