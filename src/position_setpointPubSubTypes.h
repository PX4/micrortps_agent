...
/*!
 * @file position_setpointPubSubTypes.h
...
#ifndef _POSITION_SETPOINT_PUBSUBTYPES_H_
#define _POSITION_SETPOINT_PUBSUBTYPES_H_
...
#error Generated position_setpoint is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 */
class position_setpointPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef position_setpoint type;

    eProsima_user_DllExport position_setpointPubSubType();

    eProsima_user_DllExport virtual ~position_setpointPubSubType();
...
#endif // _POSITION_SETPOINT_PUBSUBTYPES_H_