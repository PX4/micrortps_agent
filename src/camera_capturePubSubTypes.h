...
/*!
 * @file camera_capturePubSubTypes.h
...
#ifndef _CAMERA_CAPTURE_PUBSUBTYPES_H_
#define _CAMERA_CAPTURE_PUBSUBTYPES_H_
...
#error Generated camera_capture is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

typedef std::array<float, 4> camera_capture__float_array_4;
/*!
 * @brief This class represents the TopicDataType of the type camera_capture defined by the user in the IDL file.
 * @ingroup CAMERA_CAPTURE
 */
class camera_capturePubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef camera_capture type;

    eProsima_user_DllExport camera_capturePubSubType();

    eProsima_user_DllExport virtual ~camera_capturePubSubType();
...
#endif // _CAMERA_CAPTURE_PUBSUBTYPES_H_