...
/*!
 * @file obstacle_distancePubSubTypes.h
...
#ifndef _OBSTACLE_DISTANCE_PUBSUBTYPES_H_
#define _OBSTACLE_DISTANCE_PUBSUBTYPES_H_
...
#error Generated obstacle_distance is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
/*!
 * @brief This class represents the TopicDataType of the type obstacle_distance defined by the user in the IDL file.
 * @ingroup OBSTACLE_DISTANCE
 */
class obstacle_distancePubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef obstacle_distance type;

    eProsima_user_DllExport obstacle_distancePubSubType();

    eProsima_user_DllExport virtual ~obstacle_distancePubSubType();
...
#endif // _OBSTACLE_DISTANCE_PUBSUBTYPES_H_