...
/*!
 * @file debug_key_valuePubSubTypes.h
...
#ifndef _DEBUG_KEY_VALUE_PUBSUBTYPES_H_
#define _DEBUG_KEY_VALUE_PUBSUBTYPES_H_
...
#error Generated debug_key_value is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

typedef std::array<char, 10> debug_key_value__char_array_10;
/*!
 * @brief This class represents the TopicDataType of the type debug_key_value defined by the user in the IDL file.
 * @ingroup DEBUG_KEY_VALUE
 */
class debug_key_valuePubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef debug_key_value type;

    eProsima_user_DllExport debug_key_valuePubSubType();

    eProsima_user_DllExport virtual ~debug_key_valuePubSubType();
...
#endif // _DEBUG_KEY_VALUE_PUBSUBTYPES_H_