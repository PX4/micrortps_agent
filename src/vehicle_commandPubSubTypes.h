...
/*!
 * @file vehicle_commandPubSubTypes.h
...
#ifndef _VEHICLE_COMMAND_PUBSUBTYPES_H_
#define _VEHICLE_COMMAND_PUBSUBTYPES_H_
...
#error Generated vehicle_command is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 */
class vehicle_commandPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef vehicle_command type;

    eProsima_user_DllExport vehicle_commandPubSubType();

    eProsima_user_DllExport virtual ~vehicle_commandPubSubType();
...
#endif // _VEHICLE_COMMAND_PUBSUBTYPES_H_