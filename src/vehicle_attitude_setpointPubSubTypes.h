...
/*!
 * @file vehicle_attitude_setpointPubSubTypes.h
...
#ifndef _VEHICLE_ATTITUDE_SETPOINT_PUBSUBTYPES_H_
#define _VEHICLE_ATTITUDE_SETPOINT_PUBSUBTYPES_H_
...
#error Generated vehicle_attitude_setpoint is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 */
class vehicle_attitude_setpointPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef vehicle_attitude_setpoint type;

    eProsima_user_DllExport vehicle_attitude_setpointPubSubType();

    eProsima_user_DllExport virtual ~vehicle_attitude_setpointPubSubType();
...
#endif // _VEHICLE_ATTITUDE_SETPOINT_PUBSUBTYPES_H_